...
def train_gan(self, epoch, grads):
    ...
    # BEN: This is our auxiliary dataset
    ...
    #betas appear here from GAN github, but not in our attack code SGD instantiation. May need to look into this
    ...
    for i, (imgs, _) in enumerate(dataloader):
        ...
        #BEN: must update D with grads somehow
        ...
        #the real loss might be the agg_grad??
        ...
        if batches_done % opt.sample_interval == 0:
            ...
            audit_data = gen_imgs #maybe? audit_data should be final set of images once G/D are well trained       
